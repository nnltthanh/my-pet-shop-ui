...
@Component({
    selector: 'app-report-display-number-of-products',
    standalone: true,
    imports: [ChartModule],
    templateUrl: './report-display-number-of-products.component.html',
    styleUrl: './report-display-number-of-products.component.scss'
})
export class ReportDisplayNumberOfProductsComponent {
                ...
                datasets: [
                    {
                        ...
                        data: this.reportData()?.previousNumberOfProducts,
                        tension: 0.4,
                    },
                    {
                        ...
                        data: this.reportData()?.currentNumberOfProducts,
                        tension: 0.4,
                    }
                ]
            };
