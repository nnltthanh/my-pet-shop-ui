...
@Component({
    selector: 'app-report-display-number-of-orders',
    standalone: true,
    imports: [ChartModule],
    templateUrl: './report-display-number-of-orders.component.html',
    styleUrl: './report-display-number-of-orders.component.scss'
})
export class ReportDisplayNumberOfOrdersComponent {
                ...
                datasets: [
                    {
                        ...
                        data: this.reportData()?.previousNumberOfOrders,
                        tension: 0.4,
                    },
                    {
                        ...
                        data: this.reportData()?.currentNumberOfOrders,
                        tension: 0.4,
                    }
                ]
            };
