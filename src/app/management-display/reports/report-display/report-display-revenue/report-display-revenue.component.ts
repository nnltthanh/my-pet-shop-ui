...
@Component({
    selector: 'app-report-display-revenue',
    standalone: true,
    imports: [ChartModule],
    templateUrl: './report-display-revenue.component.html',
    styleUrl: './report-display-revenue.component.scss'
})
export class ReportDisplayRevenueComponent {
                ...
                datasets: [
                    {
                        ...
                        data: this.reportData()?.previousTimeRevenue,
                        tension: 0.4,
                    },
                    {
                        ...
                        data: this.reportData()?.currentTimeRevenue,
                        tension: 0.4,
                    }
                ]
            };
